...
This webbapp is deployed in Microsoft Azure via a script that's written in Bash as a demonstration of Infrastructure as Code. It combines and shows the power of CLI, Cloud, Linux and (Docker) containers.

**It is meant for demonstration purposes only.**

The webapp consists of the following files:
- config/variables
...
- config/cred
This file contains the credentials to log in to Azure. Of course, this file is empty. You should enter your own credentials. Please make sure you do not put file on your own Github account with your credentials in it. Best practice is to use a [Service Principal](https://docs.microsoft.com/en-us/azure/active-directory/develop/app-objects-and-service-principals)

- docker/dockerfile
This is the blueprint for the Docker container. It pulls an (Apache) httpd container image from the public Docker registry, which acts as a webserver.
